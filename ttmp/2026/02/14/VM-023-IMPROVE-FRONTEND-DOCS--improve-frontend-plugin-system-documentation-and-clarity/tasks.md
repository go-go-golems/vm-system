...
- [x] Produce code-first frontend plugin architecture analysis before reading docs
...
- [ ] Update quickstart/examples docs to use correct ui.input/ui.table signatures and include explicit ui.column example
